...
<b>* </b>When using the 18.432 MHz option (or any frequency by which 64 cannot be divided evenly), timing functions with generated by timers (millis, micros, delay, delayMicroseconds) will not be accurate.
for static delays use *_delay_ms()* and *_delay_us()* instead.
</br></br>
