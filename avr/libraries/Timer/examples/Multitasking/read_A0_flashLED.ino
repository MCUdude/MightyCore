...
void setup() {
  ...
  t.every(pause1, toggle, (void*)0); // (pause, method, pass value) - run the "toggle" method every 100 ms, and pass the value '0' to the "toggle" method
  t.every(pause2, takeReading, (void*)1); // (pause, method) - run the "takeReading" method every 1000 ms, and pass the value '1' to the "takeReading" method
}
